import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, type DotItemDotProps } from 'recharts';
...
export default function DisplayDotLineChart({ chartDatas }: chartsDatabase) {
  return (
    ...
    >
      ...
      <Tooltip />
      <Legend />
      <Line type="monotone" dataKey="Nombre de tournages" stroke="#ffffff01" dot={CustomizedDot} />
    </LineChart>
  );
};